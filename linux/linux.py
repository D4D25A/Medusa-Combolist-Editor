import sys,time,os,send,tty,termios,random,requests,chardet,subprocess,shutil,psutil,ctypes,fileinput,textwrap,itertools,socket,re,threading,pygame
        ...
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s: 
            ...
            def localeditone():
                ...
                def emailpassuhq():
                    ...
                    combofullpath = input(f'{bcolors.CYAN}Please enter {bcolors.OKGREEN}combolist {bcolors.CYAN}file path: {bcolors.ENDC}')
                    try:
